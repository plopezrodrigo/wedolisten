...
Revision ID: 472dbf5cd1ee
Revises: 
Create Date: 2023-02-10 15:17:59.043613
...
def upgrade():
    ...
    sa.Column('puntuacion', sa.Enum('cero', 'uno', 'dos', 'tres', 'cuatro', 'cinco', name='puntuaciones'), nullable=True),
