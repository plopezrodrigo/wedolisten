						...
						<div className="card px-3" id="card">
							<form className="form-outline" noValidate onSubmit={handleSubmit}>
								<div className="col-md-12">
									<p>{" "}</p>
									<label htmlFor="InputEmail1" className="alinear-izquierda mt-3">Nombre del local</label>
									<input type="text" name="name" required className="form-control mb-2 me-2" id="InputName1" aria-describedby="nameHelp" onChange={handleChange} />
								</div>
								<div className="col-md-12"> 
									...
									<input className="form-control mb-2 me-2" type="url" name="image_url" required id="InputImage_url"  aria-describedby="image_urlHelp"  onChange={handleChange} />
								</div>
								<div className="col-md-12">
									<label className="alinear-izquierda" htmlFor="InputEmail1">Descripción</label>
									<textarea id="textarea" name="description" required rows="3" cols="49" onChange={handleChange} ></textarea>
								</div>
								<div className="col-md-12">
									<label className="alinear-izquierda mb-2 me-2" htmlFor="Inputurl1">Información de contacto</label>
								...
								<div className="col-md-12">
									<label className="alinear-izquierda mt-2" htmlFor="InputEmail1">Características</label><br/>
								</div>
								<div class="container">
								...
								<div className="col-md-12 mt-3">
									...
									<input className="form-control mb-2 me-2" type="url" name="image_url1"         id="InputImage_url1" aria-describedby="image_urlHelp1" placeholder="Añade Url de la imagen del local" onChange={handleChange} />
									<input className="form-control mb-2 me-2" type="url" name="image_url2"         id="InputImage_url2" aria-describedby="image_urlHelp2" placeholder="Añade Url de la imagen del local" onChange={handleChange} />
								</div>
								<div className="py-3 px-0 mx-0 d-flex justify-content-around">
									<button type="submit" className="btn btn-primary px-5 mb-3 mt-3" id="button">Guardar</button>
								</div>
